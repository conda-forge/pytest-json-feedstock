About pytest-json-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-json-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3279&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-json-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytest-json` can be installed with `conda`:
...
```
mamba install pytest-json
```

It is possible to list all of the versions of `pytest-json` available on your platform with `conda`:
...
```
mamba search pytest-json --channel conda-forge
```
...
mamba repoquery search pytest-json --channel conda-forge

# List packages depending on `pytest-json`:
mamba repoquery whoneeds pytest-json --channel conda-forge

# List dependencies of `pytest-json`:
mamba repoquery depends pytest-json --channel conda-forge
```
